...
int uECC_valid_private_key(const uint8_t *private_key, uECC_Curve curve) {
#if uECC_VLI_NATIVE_LITTLE_ENDIAN
    uECC_word_t *_private = (uECC_word_t *)private_key;
#else
    uECC_word_t _private[uECC_MAX_WORDS];
...
//void uECC_bn_addMod(uECC_Curve curve, uint8_t result[32], uint8_t left[32], uint8_t right[32]) {
//    uECC_word_t _result[8];
//    uECC_word_t _left[8];
//    uECC_word_t _right[8];
//
//#if uECC_VLI_NATIVE_LITTLE_ENDIAN
//    memcpy(_left, left, 32);
//    memcpy(_right, right, 32);
////#else
////    uECC_word_t _private[8];
//#endif
//
//#if uECC_VLI_NATIVE_LITTLE_ENDIAN == 0
//    uECC_vli_bytesToNative(_left, left, 32);
//    uECC_vli_bytesToNative(_right, right, 32);
//#endif
//
//    //uECC_vli_add(_result, _left, _right, 8);
//    //uECC_vli_modAdd(_result, _left, _right, curve->p, curve->num_words);
//    uECC_vli_add(_result, _left, _right, curve->num_words);
//
//#if uECC_VLI_NATIVE_LITTLE_ENDIAN
//    memcpy(result, _result, 32);
//#endif
//
//#if uECC_VLI_NATIVE_LITTLE_ENDIAN == 0
//    uECC_vli_nativeToBytes(result, 32, _result);
//#endif
//}
