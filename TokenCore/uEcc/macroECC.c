...
#ifndef mECC_PLATFORM
    #if __AVR__
        #define mECC_PLATFORM mECC_avr
    #elif defined(__thumb2__) || defined(_M_ARMT) /* I think MSVC only supports Thumb-2 targets */
        #define mECC_PLATFORM mECC_arm_thumb2
    #elif defined(__thumb__)
        #define mECC_PLATFORM mECC_arm_thumb
    #elif defined(__arm__) || defined(_M_ARM)
        #define mECC_PLATFORM mECC_arm
    #elif defined(__i386__) || defined(_M_IX86) || defined(_X86_) || defined(__I86__)
        #define mECC_PLATFORM mECC_x86
    #elif defined(__amd64__) || defined(_M_X64)
        #define mECC_PLATFORM mECC_x86_64
    #else
        #define mECC_PLATFORM mECC_arch_other
    #endif
#endif

#ifndef mECC_WORD_SIZE
    #if mECC_PLATFORM == mECC_avr
        #define mECC_WORD_SIZE 1
    #elif (mECC_PLATFORM == mECC_x86_64)
        #define mECC_WORD_SIZE 8
    #else
        #define mECC_WORD_SIZE 4
    #endif
#endif

#if (mECC_CURVE == mECC_secp160r1 || mECC_CURVE == mECC_secp224r1) && (mECC_WORD_SIZE == 8)
    #undef mECC_WORD_SIZE
    #define mECC_WORD_SIZE 4
    #if (mECC_PLATFORM == mECC_x86_64)
        #undef mECC_PLATFORM
        #define mECC_PLATFORM mECC_x86
    #endif
#endif

#if (mECC_WORD_SIZE != 1) && (mECC_WORD_SIZE != 4) && (mECC_WORD_SIZE != 8)
    #error "Unsupported value for mECC_WORD_SIZE"
#endif

#if (mECC_ASM && (mECC_PLATFORM == mECC_avr) && (mECC_WORD_SIZE != 1))
    #pragma message ("mECC_WORD_SIZE must be 1 when using AVR asm")
    #undef mECC_WORD_SIZE
    #define mECC_WORD_SIZE 1
#endif

#if (mECC_ASM && \
     (mECC_PLATFORM == mECC_arm || mECC_PLATFORM == mECC_arm_thumb) && \
     (mECC_WORD_SIZE != 4))
    #pragma message ("mECC_WORD_SIZE must be 4 when using ARM asm")
    #undef mECC_WORD_SIZE
    #define mECC_WORD_SIZE 4
#endif
...
typedef uint8_t mECC_word_t;
typedef uint16_t mECC_dword_t;
...
#define mECC_WORD_BITS 8
#define mECC_WORD_BITS_SHIFT 3
#define mECC_WORD_BITS_MASK 0x07

#define mECC_WORDS_1 20
#define mECC_WORDS_2 24
#define mECC_WORDS_3 32
#define mECC_WORDS_4 32
#define mECC_WORDS_5 28

#define mECC_N_WORDS_1 21
#define mECC_N_WORDS_2 24
#define mECC_N_WORDS_3 32
#define mECC_N_WORDS_4 32
#define mECC_N_WORDS_5 28
...
#elif (mECC_WORD_SIZE == 4)

typedef uint32_t mECC_word_t;
typedef uint64_t mECC_dword_t;
...
#define mECC_WORD_BITS 32
#define mECC_WORD_BITS_SHIFT 5
#define mECC_WORD_BITS_MASK 0x01F

#define mECC_WORDS_1 5
#define mECC_WORDS_2 6
#define mECC_WORDS_3 8
#define mECC_WORDS_4 8
#define mECC_WORDS_5 7

#define mECC_N_WORDS_1 6
#define mECC_N_WORDS_2 6
#define mECC_N_WORDS_3 8
#define mECC_N_WORDS_4 8
#define mECC_N_WORDS_5 7
...
#elif (mECC_WORD_SIZE == 8)

typedef uint64_t mECC_word_t;
#if SUPPORTS_INT128
typedef unsigned __int128 mECC_dword_t;
#endif
typedef unsigned wordcount_t;
typedef int swordcount_t;
typedef int bitcount_t;
...
#define mECC_WORD_BITS 64
#define mECC_WORD_BITS_SHIFT 6
#define mECC_WORD_BITS_MASK 0x03F

#define mECC_WORDS_1 3
#define mECC_WORDS_2 3
#define mECC_WORDS_3 4
#define mECC_WORDS_4 4
#define mECC_WORDS_5 4

#define mECC_N_WORDS_1 3
#define mECC_N_WORDS_2 3
#define mECC_N_WORDS_3 4
#define mECC_N_WORDS_4 4
#define mECC_N_WORDS_5 4
...
#endif /* (mECC_WORD_SIZE == 8) */

#define mECC_WORDS mECC_CONCAT(mECC_WORDS_, mECC_CURVE)
#define mECC_N_WORDS mECC_CONCAT(mECC_N_WORDS_, mECC_CURVE)

typedef struct EccPoint {
    mECC_word_t x[mECC_WORDS];
    mECC_word_t y[mECC_WORDS];
} EccPoint;

static const mECC_word_t curve_p[mECC_WORDS] = mECC_CONCAT(Curve_P_, mECC_CURVE);
static const mECC_word_t curve_b[mECC_WORDS] = mECC_CONCAT(Curve_B_, mECC_CURVE);
static const EccPoint curve_G = mECC_CONCAT(Curve_G_, mECC_CURVE);
static const mECC_word_t curve_n[mECC_N_WORDS] = mECC_CONCAT(Curve_N_, mECC_CURVE);

static void vli_clear(mECC_word_t *vli);
static mECC_word_t vli_isZero(const mECC_word_t *vli);
static mECC_word_t vli_testBit(const mECC_word_t *vli, bitcount_t bit);
static bitcount_t vli_numBits(const mECC_word_t *vli, wordcount_t max_words);
static void vli_set(mECC_word_t *dest, const mECC_word_t *src);
static cmpresult_t vli_cmp(const mECC_word_t *left, const mECC_word_t *right);
static cmpresult_t vli_equal(const mECC_word_t *left, const mECC_word_t *right);
static void vli_rshift1(mECC_word_t *vli);
static mECC_word_t vli_add(mECC_word_t *result,
                           const mECC_word_t *left,
                           const mECC_word_t *right);
static mECC_word_t vli_sub(mECC_word_t *result,
                           const mECC_word_t *left,
                           const mECC_word_t *right);
static void vli_mult(mECC_word_t *result, const mECC_word_t *left, const mECC_word_t *right);
static void vli_modAdd(mECC_word_t *result,
                       const mECC_word_t *left,
                       const mECC_word_t *right,
                       const mECC_word_t *mod);
static void vli_modSub(mECC_word_t *result,
                       const mECC_word_t *left,
                       const mECC_word_t *right,
                       const mECC_word_t *mod);
static void vli_mmod_fast(mECC_word_t *RESTRICT result, mECC_word_t *RESTRICT product);
static void vli_modMult_fast(mECC_word_t *result,
                             const mECC_word_t *left,
                             const mECC_word_t *right);
static void vli_modInv(mECC_word_t *result, const mECC_word_t *input, const mECC_word_t *mod);
#if mECC_SQUARE_FUNC
static void vli_square(mECC_word_t *result, const mECC_word_t *left);
static void vli_modSquare_fast(mECC_word_t *result, const mECC_word_t *left);
#endif
...
static int default_RNG(uint8_t *dest, unsigned size) {
    ...
    (defined(__APPLE__) && defined(__MACH__)) || defined(mECC_POSIX)
...
static mECC_RNG_Function g_rng_function = &default_RNG;
...
void mECC_set_rng(mECC_RNG_Function rng_function) {
    ...
    #if (mECC_ASM && (mECC_PLATFORM == mECC_avr))
        #include "asm_avr.inc"
    #endif

    #if (mECC_ASM && (mECC_PLATFORM == mECC_arm || mECC_PLATFORM == mECC_arm_thumb || \
                      mECC_PLATFORM == mECC_arm_thumb2))
        #include "asm_arm.inc"
    #endif
#endif
...
#if !asm_testBit
static mECC_word_t vli_testBit(const mECC_word_t *vli, bitcount_t bit) {
    return (vli[bit >> mECC_WORD_BITS_SHIFT] & ((mECC_word_t)1 << (bit & mECC_WORD_BITS_MASK)));
}
#endif

/* Counts the number of words in vli. */
#if !asm_numBits
static wordcount_t vli_numDigits(const mECC_word_t *vli, wordcount_t max_words) {
    swordcount_t i;
...
static bitcount_t vli_numBits(const mECC_word_t *vli, wordcount_t max_words) {
    ...
    return (((bitcount_t)(num_digits - 1) << mECC_WORD_BITS_SHIFT) + i);
}
#endif /* !asm_numBits */
...
static void vli_rshift1(mECC_word_t *vli) {
    ...
    vli += mECC_WORDS;
    while (vli-- > end) {
        mECC_word_t temp = *vli;
        *vli = (temp >> 1) | carry;
        carry = temp << (mECC_WORD_BITS - 1);
    }
}
#endif
...
#if !asm_add
static mECC_word_t vli_add(mECC_word_t *result, const mECC_word_t *left, const mECC_word_t *right) {
    mECC_word_t carry = 0;
    wordcount_t i;
    for (i = 0; i < mECC_WORDS; ++i) {
        mECC_word_t sum = left[i] + right[i] + carry;
        if (sum != left[i]) {
            carry = (sum < left[i]);
        }
        result[i] = sum;
...
#if !asm_sub
static mECC_word_t vli_sub(mECC_word_t *result, const mECC_word_t *left, const mECC_word_t *right) {
    mECC_word_t borrow = 0;
    wordcount_t i;
    for (i = 0; i < mECC_WORDS; ++i) {
        mECC_word_t diff = left[i] - right[i] - borrow;
        if (diff != left[i]) {
            borrow = (diff > left[i]);
        }
        result[i] = diff;
...
#if (!asm_mult || (mECC_SQUARE_FUNC && !asm_square) || mECC_CURVE == mECC_secp256k1)
static void muladd(mECC_word_t a,
                   mECC_word_t b,
                   mECC_word_t *r0,
                   mECC_word_t *r1,
                   mECC_word_t *r2) {
#if mECC_WORD_SIZE == 8 && !SUPPORTS_INT128
...
#else
    mECC_dword_t p = (mECC_dword_t)a * b;
    mECC_dword_t r01 = ((mECC_dword_t)(*r1) << mECC_WORD_BITS) | *r0;
    r01 += p;
    *r2 += (r01 < p);
    *r1 = r01 >> mECC_WORD_BITS;
    *r0 = (mECC_word_t)r01;
#endif
}
...
static void vli_mult(mECC_word_t *result, const mECC_word_t *left, const mECC_word_t *right) {
    ...
    for (k = mECC_WORDS; k < mECC_WORDS * 2 - 1; ++k) {
        for (i = (k + 1) - mECC_WORDS; i < mECC_WORDS; ++i) {
            muladd(left[i], right[k - i], &r0, &r1, &r2);
        }
        result[k] = r0;
        r0 = r1;
...
#if !asm_square
static void mul2add(mECC_word_t a,
                    mECC_word_t b,
                    mECC_word_t *r0,
                    mECC_word_t *r1,
                    mECC_word_t *r2) {
...
static void vli_square(mECC_word_t *result, const mECC_word_t *left) {
    ...
    for (k = 0; k < mECC_WORDS * 2 - 1; ++k) {
        mECC_word_t min = (k < mECC_WORDS ? 0 : (k + 1) - mECC_WORDS);
...
static void vli_modAdd(mECC_word_t *result,
                       ...
                       const mECC_word_t *right,
                       const mECC_word_t *mod) {
    mECC_word_t carry = vli_add(result, left, right);
...
static void vli_modSub(mECC_word_t *result,
                       ...
                       const mECC_word_t *right,
                       const mECC_word_t *mod) {
    mECC_word_t l_borrow = vli_sub(result, left, right);
    if (l_borrow) {
...
#if (mECC_CURVE == mECC_secp160r1 || mECC_CURVE == mECC_secp256k1)
/* omega_mult() is defined farther below for the different curves / word sizes */
static void omega_mult(mECC_word_t * RESTRICT result, const mECC_word_t * RESTRICT right);
...
static void vli_mmod_fast(mECC_word_t *RESTRICT result, mECC_word_t *RESTRICT product) {
    mECC_word_t tmp[2 * mECC_WORDS];
    mECC_word_t carry;

    vli_clear(tmp);
    vli_clear(tmp + mECC_WORDS);

    omega_mult(tmp, product + mECC_WORDS); /* (Rq, q) = q * c */

    carry = vli_add(result, product, tmp); /* (C, r) = r + q       */
    vli_clear(product);
    omega_mult(product, tmp + mECC_WORDS); /* Rq*c */
...
#elif mECC_CURVE == mECC_secp256r1

/* Computes result = product % curve_p
   from http://www.nsa.gov/ia/_files/nist-routines.pdf */
#if mECC_WORD_SIZE == 1
static void vli_mmod_fast(uint8_t *RESTRICT result, uint8_t *RESTRICT product) {
    uint8_t tmp[mECC_BYTES];
    int8_t carry;
...
#elif mECC_CURVE == mECC_secp256k1
...
static void omega_mult(uint8_t * RESTRICT result, const uint8_t * RESTRICT right) {
    ...
    muladd(0x03, right[mECC_WORDS - 1], &r0, &r1, &r2);
    result[mECC_WORDS] = r0;
    result[mECC_WORDS + 1] = r1;

    result[4 + mECC_WORDS] = vli_add(result + 4, result + 4, right); /* add the 2^32 multiple */
}
#elif mECC_WORD_SIZE == 4
static void omega_mult(uint32_t * RESTRICT result, const uint32_t * RESTRICT right) {
    /* Multiply by (2^9 + 2^8 + 2^7 + 2^6 + 2^4 + 1). */
    ...
    result[mECC_WORDS] = carry;

    result[1 + mECC_WORDS] = vli_add(result + 1, result + 1, right); /* add the 2^32 multiple */
}
#else
...
#elif mECC_CURVE == mECC_secp224r1
...
static void vli_modMult_fast(mECC_word_t *result,
                             const mECC_word_t *left,
                             const mECC_word_t *right) {
    mECC_word_t product[2 * mECC_WORDS];
...
#if !asm_modInv
static void vli_modInv(mECC_word_t *result, const mECC_word_t *input, const mECC_word_t *mod) {
    mECC_word_t a[mECC_WORDS], b[mECC_WORDS], u[mECC_WORDS], v[mECC_WORDS];
    mECC_word_t carry;
...
/* Double in place */
#if (mECC_CURVE == mECC_secp256k1)
static void EccPoint_double_jacobian(mECC_word_t * RESTRICT X1,
                                     mECC_word_t * RESTRICT Y1,
                                     mECC_word_t * RESTRICT Z1) {
    /* t1 = X, t2 = Y, t3 = Z */
    mECC_word_t t4[mECC_WORDS];
    mECC_word_t t5[mECC_WORDS];
    ...
    if (vli_testBit(Y1, 0)) {
        mECC_word_t carry = vli_add(Y1, Y1, curve_p);
        vli_rshift1(Y1);
        Y1[mECC_WORDS - 1] |= carry << (mECC_WORD_BITS - 1);
    } else {
        vli_rshift1(Y1);
    }
    /* t2 = 3/2*(x1^2) = B */
...
static void EccPoint_double_jacobian(mECC_word_t * RESTRICT X1,
    ...
    if (vli_testBit(X1, 0)) {
        mECC_word_t l_carry = vli_add(X1, X1, curve_p);
        vli_rshift1(X1);
        X1[mECC_WORDS - 1] |= l_carry << (mECC_WORD_BITS - 1);
    } else {
        vli_rshift1(X1);
    }
    /* t1 = 3/2*(x1^2 - z1^4) = B */
...
static void apply_z(mECC_word_t * RESTRICT X1,
                    mECC_word_t * RESTRICT Y1,
                    const mECC_word_t * RESTRICT Z) {
    mECC_word_t t1[mECC_WORDS];
...
/* P = (x1, y1) => 2P, (x2, y2) => P' */
static void XYcZ_initial_double(mECC_word_t * RESTRICT X1,
                                mECC_word_t * RESTRICT Y1,
                                mECC_word_t * RESTRICT X2,
                                mECC_word_t * RESTRICT Y2,
                                const mECC_word_t * RESTRICT initial_Z) {
    mECC_word_t z[mECC_WORDS];
    if (initial_Z) {
        vli_set(z, initial_Z);
    } else {
        vli_clear(z);
...
/* Input P = (x1, y1, Z), Q = (x2, y2, Z)
   ...
   or P => P', Q => P + Q
*/
static void XYcZ_add(mECC_word_t * RESTRICT X1,
                     mECC_word_t * RESTRICT Y1,
                     mECC_word_t * RESTRICT X2,
                     mECC_word_t * RESTRICT Y2) {
...
/* Input P = (x1, y1, Z), Q = (x2, y2, Z)
   ...
   or P => P - Q, Q => P + Q
*/
static void XYcZ_addC(mECC_word_t * RESTRICT X1,
                      mECC_word_t * RESTRICT Y1,
                      mECC_word_t * RESTRICT X2,
                      mECC_word_t * RESTRICT Y2) {
    /* t1 = X1, t2 = Y1, t3 = X2, t4 = Y2 */
    mECC_word_t t5[mECC_WORDS];
    mECC_word_t t6[mECC_WORDS];
    mECC_word_t t7[mECC_WORDS];
...
static void EccPoint_mult(EccPoint * RESTRICT result,
                          ...
                          const mECC_word_t * RESTRICT scalar,
                          const mECC_word_t * RESTRICT initialZ,
                          bitcount_t numBits) {
    /* R0 and R1 */
    mECC_word_t Rx[2][mECC_WORDS];
    mECC_word_t Ry[2][mECC_WORDS];
    mECC_word_t z[mECC_WORDS];
    bitcount_t i;
    mECC_word_t nb;
...
static int EccPoint_compute_public_key(EccPoint *result, mECC_word_t *private) {
    mECC_word_t tmp1[mECC_WORDS];
    mECC_word_t tmp2[mECC_WORDS];
    mECC_word_t *p2[2] = {tmp1, tmp2};
    mECC_word_t carry;
    ...
    EccPoint_mult(result, &curve_G, private, 0, vli_numBits(private, mECC_WORDS));
#else
    ...
    EccPoint_mult(result, &curve_G, p2[!carry], 0, (mECC_BYTES * 8) + 1);
#endif
...
#if mECC_CURVE == mECC_secp224r1

/* Routine 3.2.4 RS;  from http://www.nsa.gov/ia/_files/nist-routines.pdf */
static void mod_sqrt_secp224r1_rs(mECC_word_t *d1,
                                  mECC_word_t *e1,
                                  mECC_word_t *f1,
                                  const mECC_word_t *d0,
                                  const mECC_word_t *e0,
                                  const mECC_word_t *f0) {
    mECC_word_t t[mECC_WORDS];
...
static void mod_sqrt_secp224r1_rss(mECC_word_t *d1,
                                   mECC_word_t *e1,
                                   mECC_word_t *f1,
                                   const mECC_word_t *d0,
                                   const mECC_word_t *e0,
...
static void mod_sqrt_secp224r1_rm(mECC_word_t *d2,
                                  mECC_word_t *e2,
                                  mECC_word_t *f2,
                                  const mECC_word_t *c,
                                  const mECC_word_t *d0,
                                  const mECC_word_t *e0,
                                  const mECC_word_t *d1,
                                  const mECC_word_t *e1) {
    mECC_word_t t1[mECC_WORDS];
    mECC_word_t t2[mECC_WORDS];
...
static void mod_sqrt_secp224r1_rp(mECC_word_t *d1,
                                  mECC_word_t *e1,
                                  mECC_word_t *f1,
                                  const mECC_word_t *c,
                                  const mECC_word_t *r) {
    wordcount_t i;
    wordcount_t pow2i = 1;
    mECC_word_t d0[mECC_WORDS];
    mECC_word_t e0[mECC_WORDS] = {1};          /* e0 <-- 1 */
    mECC_word_t f0[mECC_WORDS];
...
static void mod_sqrt(mECC_word_t *a) {
    bitcount_t i;
    mECC_word_t e1[mECC_WORDS];
    mECC_word_t f1[mECC_WORDS];
    mECC_word_t d0[mECC_WORDS];
    mECC_word_t e0[mECC_WORDS];
    mECC_word_t f0[mECC_WORDS];
    mECC_word_t d1[mECC_WORDS];
...
static void mod_sqrt(mECC_word_t *a) {
    bitcount_t i;
    mECC_word_t p1[mECC_WORDS] = {1};
    mECC_word_t l_result[mECC_WORDS] = {1};

    /* Since curve_p == 3 (mod 4) for all supported curves, we can
       compute sqrt(a) = a^((curve_p + 1) / 4) (mod curve_p). */
    vli_add(p1, curve_p, p1); /* p1 = curve_p + 1 */
    for (i = vli_numBits(p1, mECC_WORDS) - 1; i > 1; --i) {
...
static void vli_nativeToBytes(uint8_t * RESTRICT dest, const uint8_t * RESTRICT src) {
    uint8_t i;
    for (i = 0; i < mECC_BYTES; ++i) {
        dest[i] = src[(mECC_BYTES - 1) - i];
    }
}
...
static void vli_nativeToBytes(uint8_t *bytes, const uint32_t *native) {
    unsigned i;
    for (i = 0; i < mECC_WORDS; ++i) {
        uint8_t *digit = bytes + 4 * (mECC_WORDS - 1 - i);
        digit[0] = native[i] >> 24;
        digit[1] = native[i] >> 16;
        digit[2] = native[i] >> 8;
        digit[3] = native[i];
...
static void vli_bytesToNative(uint32_t *native, const uint8_t *bytes) {
    unsigned i;
    for (i = 0; i < mECC_WORDS; ++i) {
        const uint8_t *digit = bytes + 4 * (mECC_WORDS - 1 - i);
...
static void vli_nativeToBytes(uint8_t *bytes, const uint64_t *native) {
    unsigned i;
    for (i = 0; i < mECC_WORDS; ++i) {
        uint8_t *digit = bytes + 8 * (mECC_WORDS - 1 - i);
        digit[0] = native[i] >> 56;
        digit[1] = native[i] >> 48;
        digit[2] = native[i] >> 40;
        digit[3] = native[i] >> 32;
...
static void vli_bytesToNative(uint64_t *native, const uint8_t *bytes) {
    unsigned i;
    for (i = 0; i < mECC_WORDS; ++i) {
        const uint8_t *digit = bytes + 8 * (mECC_WORDS - 1 - i);
...
int mECC_make_key(uint8_t public_key[mECC_BYTES*2], uint8_t private_key[mECC_BYTES]) {
    mECC_word_t private[mECC_WORDS];
    EccPoint public;
    mECC_word_t tries;
    for (tries = 0; tries < MAX_TRIES; ++tries) {
        if (g_rng_function((uint8_t *)private, sizeof(private)) &&
            ...
            vli_nativeToBytes(public_key + mECC_BYTES, public.y);
            return 1;
        }
    }
    return 0;
...
int mECC_shared_secret(const uint8_t public_key[mECC_BYTES*2],
    ...
    EccPoint product;
    mECC_word_t private[mECC_WORDS];
    mECC_word_t tmp[mECC_WORDS];
    mECC_word_t *p2[2] = {private, tmp};
    mECC_word_t random[mECC_WORDS];
    mECC_word_t *initial_Z = 0;
    mECC_word_t tries;
    mECC_word_t carry;
    ...
    // mECC_shared_secret() can still work without an RNG defined.
    for (tries = 0; tries < MAX_TRIES; ++tries) {
    ...
    vli_bytesToNative(public.y, public_key + mECC_BYTES);

#if (mECC_CURVE == mECC_secp160r1)
    // Don't regularize the bitcount for secp160r1.
    EccPoint_mult(&product, &public, private, initial_Z, vli_numBits(private, mECC_WORDS));
#else
    // Regularize the bitcount for the private key so that attackers cannot use a side channel
    // attack to learn the number of leading zeros.
    carry = vli_add(private, private, curve_n);
    vli_add(tmp, private, curve_n);
    EccPoint_mult(&product, &public, p2[!carry], initial_Z, (mECC_BYTES * 8) + 1);
#endif
...
void mECC_compress(const uint8_t public_key[mECC_BYTES*2], uint8_t compressed[mECC_BYTES+1]) {
    ...
    compressed[0] = 2 + (public_key[mECC_BYTES * 2 - 1] & 0x01);
}

/* Computes result = x^3 + ax + b. result must not overlap x. */
static void curve_x_side(mECC_word_t * RESTRICT result, const mECC_word_t * RESTRICT x) {
#if (mECC_CURVE == mECC_secp256k1)
    vli_modSquare_fast(result, x); /* r = x^2 */
    vli_modMult_fast(result, result, x); /* r = x^3 */
    vli_modAdd(result, result, curve_b, curve_p); /* r = x^3 + b */
#else
    mECC_word_t _3[mECC_WORDS] = {3}; /* -a = 3 */
...
void mECC_decompress(const uint8_t compressed[mECC_BYTES+1], uint8_t public_key[mECC_BYTES*2]) {
    ...
    vli_nativeToBytes(public_key + mECC_BYTES, point.y);
}
...
#if (mECC_CURVE == mECC_secp160r1)
static void vli_clear_n(mECC_word_t *vli) {
    vli_clear(vli);
    vli[mECC_N_WORDS - 1] = 0;
}

static mECC_word_t vli_isZero_n(const mECC_word_t *vli) {
    if (vli[mECC_N_WORDS - 1]) {
        return 0;
    }
    return vli_isZero(vli);
}

static void vli_set_n(mECC_word_t *dest, const mECC_word_t *src) {
    vli_set(dest, src);
    dest[mECC_N_WORDS - 1] = src[mECC_N_WORDS - 1];
}

static cmpresult_t vli_cmp_n(const mECC_word_t *left, const mECC_word_t *right) {
    if (left[mECC_N_WORDS - 1] > right[mECC_N_WORDS - 1]) {
        return 1;
    } else if (left[mECC_N_WORDS - 1] < right[mECC_N_WORDS - 1]) {
        return -1;
    }
    return vli_cmp(left, right);
}

static void vli_rshift1_n(mECC_word_t *vli) {
    vli_rshift1(vli);
    vli[mECC_N_WORDS - 2] |= vli[mECC_N_WORDS - 1] << (mECC_WORD_BITS - 1);
    vli[mECC_N_WORDS - 1] = vli[mECC_N_WORDS - 1] >> 1;
}

static mECC_word_t vli_add_n(mECC_word_t *result,
                             const mECC_word_t *left,
                             const mECC_word_t *right) {
    mECC_word_t carry = vli_add(result, left, right);
    mECC_word_t sum = left[mECC_N_WORDS - 1] + right[mECC_N_WORDS - 1] + carry;
    if (sum != left[mECC_N_WORDS - 1]) {
        carry = (sum < left[mECC_N_WORDS - 1]);
    }
    result[mECC_N_WORDS - 1] = sum;
    return carry;
}

static mECC_word_t vli_sub_n(mECC_word_t *result,
                             const mECC_word_t *left,
                             const mECC_word_t *right) {
    mECC_word_t borrow = vli_sub(result, left, right);
    mECC_word_t diff = left[mECC_N_WORDS - 1] - right[mECC_N_WORDS - 1] - borrow;
    if (diff != left[mECC_N_WORDS - 1]) {
        borrow = (diff > left[mECC_N_WORDS - 1]);
    }
    result[mECC_N_WORDS - 1] = diff;
    return borrow;
}
...
static void vli_mult_n(mECC_word_t *result, const mECC_word_t *left, const mECC_word_t *right) {
    mECC_word_t r0 = 0;
    mECC_word_t r1 = 0;
    mECC_word_t r2 = 0;
    wordcount_t i, k;

    for (k = 0; k < mECC_N_WORDS * 2 - 1; ++k) {
        wordcount_t min = (k < mECC_N_WORDS ? 0 : (k + 1) - mECC_N_WORDS);
        wordcount_t max = (k < mECC_N_WORDS ? k : mECC_N_WORDS - 1);
        for (i = min; i <= max; ++i) {
            muladd(left[i], right[k - i], &r0, &r1, &r2);
        }
        result[k] = r0;
    ...
    result[mECC_N_WORDS * 2 - 1] = r0;
}

static void vli_modAdd_n(mECC_word_t *result,
                         const mECC_word_t *left,
                         const mECC_word_t *right,
                         const mECC_word_t *mod) {
    mECC_word_t carry = vli_add_n(result, left, right);
    if (carry || vli_cmp_n(result, mod) >= 0) {
        vli_sub_n(result, result, mod);
    }
}

static void vli_modInv_n(mECC_word_t *result, const mECC_word_t *input, const mECC_word_t *mod) {
    mECC_word_t a[mECC_N_WORDS], b[mECC_N_WORDS], u[mECC_N_WORDS], v[mECC_N_WORDS];
    mECC_word_t carry;
    cmpresult_t cmpResult;
...
static void vli2_rshift1_n(mECC_word_t *vli) {
    vli_rshift1_n(vli);
    vli[mECC_N_WORDS - 1] |= vli[mECC_N_WORDS] << (mECC_WORD_BITS - 1);
    vli_rshift1_n(vli + mECC_N_WORDS);
}

static mECC_word_t vli2_sub_n(mECC_word_t *result,
                              const mECC_word_t *left,
                              const mECC_word_t *right) {
    mECC_word_t borrow = 0;
    wordcount_t i;
    for (i = 0; i < mECC_N_WORDS * 2; ++i) {
        mECC_word_t diff = left[i] - right[i] - borrow;
        if (diff != left[i]) {
            borrow = (diff > left[i]);
        }
...
static void vli_modMult_n(mECC_word_t *result, const mECC_word_t *left, const mECC_word_t *right) {
    bitcount_t i;
    mECC_word_t product[2 * mECC_N_WORDS];
    mECC_word_t modMultiple[2 * mECC_N_WORDS];
    mECC_word_t tmp[2 * mECC_N_WORDS];
    mECC_word_t *v[2] = {tmp, product};
    mECC_word_t index = 1;

    vli_mult_n(product, left, right);
    vli_clear_n(modMultiple);
    vli_set(modMultiple + mECC_N_WORDS + 1, curve_n);
    vli_rshift1(modMultiple + mECC_N_WORDS + 1);
    modMultiple[2 * mECC_N_WORDS - 1] |= HIGH_BIT_SET;
    modMultiple[mECC_N_WORDS] = HIGH_BIT_SET;

    for (i = 0;
         i <= ((((bitcount_t)mECC_N_WORDS) << mECC_WORD_BITS_SHIFT) + (mECC_WORD_BITS - 1));
         ++i) {
        mECC_word_t borrow = vli2_sub_n(v[1 - index], v[index], modMultiple);
...
static void vli2_rshift1(mECC_word_t *vli) {
    vli_rshift1(vli);
    vli[mECC_WORDS - 1] |= vli[mECC_WORDS] << (mECC_WORD_BITS - 1);
    vli_rshift1(vli + mECC_WORDS);
}

static mECC_word_t vli2_sub(mECC_word_t *result,
                            const mECC_word_t *left,
                            const mECC_word_t *right) {
    mECC_word_t borrow = 0;
    wordcount_t i;
    for (i = 0; i < mECC_WORDS * 2; ++i) {
        mECC_word_t diff = left[i] - right[i] - borrow;
        if (diff != left[i]) {
            borrow = (diff > left[i]);
        }
...
static void vli_modMult_n(mECC_word_t *result, const mECC_word_t *left, const mECC_word_t *right) {
    mECC_word_t product[2 * mECC_WORDS];
    mECC_word_t modMultiple[2 * mECC_WORDS];
    mECC_word_t tmp[2 * mECC_WORDS];
    mECC_word_t *v[2] = {tmp, product};
    bitcount_t i;
    mECC_word_t index = 1;
    ...
    vli_mult(product, left, right);
    vli_set(modMultiple + mECC_WORDS, curve_n); /* works if curve_n has its highest bit set */
    vli_clear(modMultiple);

    for (i = 0; i <= mECC_BYTES * 8; ++i) {
        mECC_word_t borrow = vli2_sub(v[1 - index], v[index], modMultiple);
        index = !(index ^ borrow); /* Swap the index if there was no borrow */
        vli2_rshift1(modMultiple);
    }
    vli_set(result, v[index]);
}
#endif /* (mECC_CURVE != mECC_secp160r1) */

static int mECC_sign_with_k(const uint8_t private_key[mECC_BYTES],
                            const uint8_t message_hash[mECC_BYTES],
                            mECC_word_t k[mECC_N_WORDS],
                            uint8_t signature[mECC_BYTES*2]) {
    mECC_word_t tmp[mECC_N_WORDS];
    mECC_word_t s[mECC_N_WORDS];
    mECC_word_t *k2[2] = {tmp, s};
    EccPoint p;
    mECC_word_t carry;
    mECC_word_t tries;
    ...
    carry = (tmp[mECC_WORDS] & 0x02);
    vli_add_n(s, tmp, curve_n);

    /* p = k * G */
    EccPoint_mult(&p, &curve_G, k2[!carry], 0, (mECC_BYTES * 8) + 2);
#else
    /* Make sure that we don't leak timing information about k.
       See http://eprint.iacr.org/2011/232.pdf */
    ...
    /* p = k * G */
    EccPoint_mult(&p, &curve_G, k2[!carry], 0, (mECC_BYTES * 8) + 1);
...
#endif
    vli_nativeToBytes(signature + mECC_BYTES, s);
    return 1;
}
...
int mECC_sign(const uint8_t private_key[mECC_BYTES],
    ...
    for (tries = 0; tries < MAX_TRIES; ++tries) {
        if(g_rng_function((uint8_t *)k, sizeof(k))) {
            ...
            k[mECC_WORDS] &= 0x01;
        #endif
            if (mECC_sign_with_k(private_key, message_hash, k, signature)) {
                return 1;
            }
        }
    }
...
static void HMAC_init(mECC_HashContext *hash_context, const uint8_t *K) {
...
static void HMAC_update(mECC_HashContext *hash_context,
                        const uint8_t *message,
                        unsigned message_size) {
    hash_context->update_hash(hash_context, message, message_size);
}

static void HMAC_finish(mECC_HashContext *hash_context, const uint8_t *K, uint8_t *result) {
    uint8_t *pad = hash_context->tmp + 2 * hash_context->result_size;
    unsigned i;
    for (i = 0; i < hash_context->result_size; ++i)
        pad[i] = K[i] ^ 0x5c;
...
/* V = HMAC_K(V) */
static void update_V(mECC_HashContext *hash_context, uint8_t *K, uint8_t *V) {
...
int mECC_sign_deterministic(const uint8_t private_key[mECC_BYTES],
    ...
    HMAC_update(hash_context, private_key, mECC_BYTES);
    HMAC_update(hash_context, message_hash, mECC_BYTES);
    ...
    for (tries = 0; tries < MAX_TRIES; ++tries) {
        ...
        if (mECC_sign_with_k(private_key, message_hash, T, signature)) {
            return 1;
        }
...
int mECC_verify(const uint8_t public_key[mECC_BYTES*2],
    ...
    mECC_word_t u1[mECC_N_WORDS], u2[mECC_N_WORDS];
    mECC_word_t z[mECC_N_WORDS];
    EccPoint public, sum;
    mECC_word_t rx[mECC_WORDS];
    mECC_word_t ry[mECC_WORDS];
    mECC_word_t tx[mECC_WORDS];
    mECC_word_t ty[mECC_WORDS];
    mECC_word_t tz[mECC_WORDS];
    const EccPoint *points[4];
    const EccPoint *point;
    bitcount_t numBits;
    bitcount_t i;
    mECC_word_t r[mECC_N_WORDS], s[mECC_N_WORDS];
    r[mECC_N_WORDS - 1] = 0;
    s[mECC_N_WORDS - 1] = 0;
    ...
    vli_bytesToNative(s, signature + mECC_BYTES);
    ...
    points[2] = &public;
    points[3] = &sum;
    numBits = smax(vli_numBits(u1, mECC_N_WORDS), vli_numBits(u2, mECC_N_WORDS));
...
void EccPoint_add(mECC_word_t * RESTRICT X1,
                  mECC_word_t * RESTRICT Y1,
                  mECC_word_t * RESTRICT X2,
                  mECC_word_t * RESTRICT Y2){
    mECC_word_t one[mECC_WORDS];
    
    // t1 = X1, t2 = X2, t4 = y1, t5 = y2
    
    
    mECC_word_t A[mECC_WORDS];
    mECC_word_t B[mECC_WORDS];
    
    mECC_word_t X3[mECC_WORDS];
    mECC_word_t Y3[mECC_WORDS];
...
int comp_char(const uint8_t pk[mECC_BYTES*2], const uint8_t ck[mECC_BYTES*2]){
    int i;
    for(i=0; i< mECC_BYTES*2;i++){
        if(pk[i] != ck[i]){
            return 0;
        }
    }
...
int mECC_sign_forbc(const uint8_t private_key[mECC_BYTES],
              const uint8_t message_hash[mECC_BYTES],
                    uint8_t signature[mECC_BYTES*2]){
    mECC_word_t s[mECC_WORDS];
    mECC_word_t r[mECC_WORDS];

    mECC_word_t s3[mECC_WORDS];
    vli_set(s3, curve_n);
    vli_rshift1(s3);
    int i = 0;
    while(i<2000){
        if(!mECC_sign(private_key, message_hash, signature)){
            continue;
        }
        vli_bytesToNative(r, signature);
        vli_bytesToNative(s, signature+mECC_BYTES);
        ...
        if(vli_numBits(r, mECC_WORDS)<256 && vli_numBits(s, mECC_WORDS)<256 && vli_numBits(r, mECC_WORDS)>248 && vli_numBits(s, mECC_WORDS) > 248){
            return macro_getRecId(private_key, message_hash, signature);
        }
        i++;
...
int macro_getRecId(const uint8_t private_key[mECC_BYTES],
    ...
    mECC_compute_public_key(private_key, public_key);
    return macro_checkSignature(public_key, hash, signature);
}

int macro_checkSignature(const uint8_t *public_key, const uint8_t *hash, const uint8_t *signature)
{
    int recid = -1;
    EccPoint  R,sum;
    mECC_word_t r[mECC_WORDS];
    mECC_word_t s[mECC_WORDS];
    mECC_word_t e[mECC_WORDS];
    mECC_word_t x[mECC_WORDS];

    mECC_word_t s3[mECC_WORDS];

    uint8_t  deR[mECC_BYTES+1];
    uint8_t  coR[mECC_BYTES*2];

    uint8_t comp_pk[mECC_BYTES*2];
    ...
    for(recid = 0; recid <4; recid ++){
        ...
        mECC_decompress(deR, coR);

        vli_bytesToNative(R.x, coR);
        vli_bytesToNative(R.y, coR+mECC_BYTES);

        EccPoint_mult(&R,&R,s,0,vli_numBits(s, mECC_N_WORDS));
        EccPoint_mult(&sum,&curve_G,e,0,vli_numBits(e, mECC_N_WORDS));
        EccPoint_add(sum.x, sum.y, R.x, R.y);

        vli_nativeToBytes(comp_pk, sum.x);
        vli_nativeToBytes(comp_pk + mECC_BYTES, sum.y);
